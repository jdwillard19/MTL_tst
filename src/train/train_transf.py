...
sys.path.append('../models')
sys.path.append('../transformer_master/tst')
...
win_shift = 100 #how much to slide the window on training set each time
save = True 
...
transformer_model = nn.Transformer(nhead=nhead, num_encoder_layers=num_encoder_layers,batch_first=True)
